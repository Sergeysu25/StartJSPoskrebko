...
function sumPokupki() {
    if (cash < sumTelef * nalog / 100) {
        console.log('Не хватает денег на счете!!!');
    } else if (cash <= sumTelef * nalog / 100) { 
        return sumPokupki = sumTelef * nalog / 100 + sumAksesuarov * nalog / 100
    }
